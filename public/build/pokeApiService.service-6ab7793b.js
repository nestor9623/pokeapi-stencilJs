...
class PokeApiService {
  ...
  async getMoveByUrl(urlNavigate) {
    return fetch(urlNavigate)
      .then(response => response.json());
  }
}

export { PokeApiService as P, createCommonjsModule as c, lodash as l };
